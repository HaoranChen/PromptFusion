...
class VisionTransformer(nn.Module):
    ...
    def __init__(
            ...
            prompt_length=None, prompt_init='uniform'):
        """
        Args:
        ...
        self.prompt = VPT_Prompt(length=prompt_length, embed_dim=embed_dim, prompt_init=prompt_init)
    ...
    def forward(self, x, task_id=-1, cls_features=None, train=False):
        feature = self.forward_features(x, task_id=task_id, cls_features=cls_features, train=train)
        res = self.head(feature)
        return res, feature
